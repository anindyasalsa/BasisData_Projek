...
<html lang="en">
 ...
 <head>
    ...
    <div class="container">
            <center><h2>Riwayat Pemeriksaan Pasien Lansia</h2></center>
          ...
          if ($_SERVER["REQUEST_METHOD"] == "POST") {
              ...
              if ($hasil->num_rows > 0) {
                  while ($row = $hasil->fetch_assoc()) {
                    ...
                    echo '      <th class="px-4 py-3">ID Registrasi </th>';
        ...
        <center>
  <button type="button" name="kembali" onclick="location.href='indexcheck.php'" class="btn btn-secondary mb-2" style="background-color: #7e3af3;">Kembali</button>
</center>
