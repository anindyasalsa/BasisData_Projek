          ...
          <ul>
            ...
            <li class="relative px-6 py-3">
              ...
              >
                ...
                <span class="ml-4">Riwayat Pemeriksaan</span>
              </a>
            </li>
            <li class="relative px-6 py-3">
              <a
...
<!-- New Table -->
  ...
  <body>
    ...
    <div class = "col-6 center-horizontal margin">
            <form action = "check.php" method="POST"> 
            <center><h2>Check Data Riwayat Pasien </h2></center>
            ...
            <center> <button type="submit" name="submit1" class="btn custom-button mb-2">Check</button> </center>
            </form>
    </div>
